...
const features = [
  {
    ...
    description:
      'Find local and online events tailored to your interests. Search by category, date, or location.',
    icon: Search,
  },
  {
    name: 'Create & Manage',
    description:
      'Host your own events with powerful tools. Manage ticket tiers, track attendance, and analyze data.',
    icon: PlusCircle,
  },
  {
    name: 'Get Tickets Instantly',
    description:
      'Secure your spot in seconds. Receive digital tickets directly to your device for easy access.',
    icon: Ticket,
  },
];
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-secondary-600 dark:text-secondary-300">
                ...
                Create memories that last a lifetime, or host your own event and
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                ...
                <Link
                  ...
                  className="text-sm font-semibold leading-6 text-secondary-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
                >
      ...
      <div className="mx-auto mt-8 max-w-7xl px-6 sm:mt-16 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-secondary-600 dark:text-secondary-400">
            Whether you are looking for something to do this weekend or planning
            a massive conference, EventO provides the tools to make it happen.
          </p>
        </div>
        ...
        <div className="mx-auto max-w-2xl lg:max-w-none">
          ...
          <dl className="mt-16 grid grid-cols-1 gap-0.5 overflow-hidden rounded-2xl text-center sm:grid-cols-3">
            {stats.map((stat) => (
              <div
                key={stat.id}
                className="flex flex-col bg-secondary-100 dark:bg-secondary-800 p-8"
              >
                <dt className="text-sm font-semibold leading-6 text-secondary-600 dark:text-secondary-400">
                  {stat.name}
                </dt>
                <dd className="order-first text-3xl font-semibold tracking-tight text-secondary-900 dark:text-white">
                  {stat.value}
                </dd>
              </div>
            ))}
        ...
        <div className="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-secondary-600 dark:text-secondary-400">
              Set up your first event in minutes. Our intuitive tools make it
              easy to manage everything from ticket sales to analytics.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link
                to="/manage/events/create"
              ...
              <Link
                to="/explore"
                className="text-sm font-semibold leading-6 text-secondary-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400"
              >
