    ...
    <div className="bg-white dark:bg-secondary-900 min-h-screen">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Transition show={mobileFiltersOpen} as={Fragment}>
          <Dialog className="relative z-50 lg:hidden" onClose={setMobileFiltersOpen}>
            <Transition.Child
              as={Fragment}
              ...
              >
                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white dark:bg-secondary-900 py-4 pb-12 shadow-xl">
                  <div className="flex items-center justify-between px-4">
                    <h2 className="text-lg font-medium text-secondary-900 dark:text-white">Filters</h2>
                    <button
                      type="button"
                  ...
                  <div className="mt-4 px-4 space-y-6">
                    <div>
                      <h3 className="text-sm font-medium text-secondary-900 dark:text-white mb-4">Search</h3>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center">
                          ...
                          />
                          <label htmlFor="mobile-category-all" className="ml-3 text-sm text-secondary-600 dark:text-secondary-400">
                            All Categories
                          </label>
                        </div>
                        {EVENT_CATEGORIES.map((category) => (
                          <div key={category} className="flex items-center">
                            <input
                              ...
                              className="h-4 w-4 border-secondary-300 text-primary-600 focus:ring-primary-600"
                            />
                            <label htmlFor={`mobile-category-${category}`} className="ml-3 text-sm text-secondary-600 dark:text-secondary-400 capitalize">
                              {category}
                            </label>
                          </div>
                        ))}
