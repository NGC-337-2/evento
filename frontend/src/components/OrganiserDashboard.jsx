...
const OrganiserDashboard = () => {
  ...
  const handleExportBookings = async (eventId, eventTitle) => {
    try {
      ...
      link.setAttribute(
        'download',
        `bookings-${eventTitle.replace(/ /g, '_')}.csv`
      );
    ...
    <div className="space-y-8 pb-12">
        ...
        <div className="col-span-12 rounded-sm border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-8">
          ...
          <div className="w-full h-[350px]">
            {stats.chartData.length > 0 ? (
              ...
              <div className="flex items-center justify-center h-full text-secondary-400 italic text-sm">
          ...
          <table className="min-w-full divide-y divide-stroke dark:divide-strokedark">
            <thead>
              <tr className="bg-gray-2 dark:bg-meta-4">
                <th
                  scope="col"
                  className="py-4 pl-6 pr-3 text-left text-sm font-semibold uppercase text-secondary-600 dark:text-secondary-400"
                >
                  Event Details
                </th>
                <th
                  scope="col"
                  className="px-3 py-4 text-center text-sm font-semibold uppercase text-secondary-600 dark:text-secondary-400"
                >
                  Status
                </th>
                <th
                ...
                <th
                  scope="col"
                  className="px-3 py-4 text-right text-sm font-semibold uppercase text-secondary-600 dark:text-secondary-400"
                >
                  Revenue
                </th>
                  ...
                  <td className="whitespace-nowrap py-5 pl-6 pr-3 text-sm">
                    <div className="flex items-center">
                      <div className="ml-4">
                        ...
                        <div className="text-secondary-500 dark:text-secondary-400 capitalize">
                          {event.category} •{' '}
                    ...
                    <div className="flex flex-col items-center">
                      <div className="w-32 bg-secondary-200 dark:bg-secondary-700 rounded-full h-2 mb-1 overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${Math.min(100, (event.totalSold / event.totalCapacity) * 100)}%`,
                          }}
                        ></div>
                      </div>
                          ...
                          <div className="py-1">
                            <MenuItem>
                              {({ focus }) => (
                                <button
                                  onClick={() =>
                                    handleExportBookings(event._id, event.title)
                                  }
                                  className={`
      ...
      <Transition show={isAttendeeModalOpen} as={Fragment}>
        <Dialog
          ...
          onClose={setIsAttendeeModalOpen}
        >
          <Transition.Child
            as={Fragment}
                ...
                <DialogPanel className="relative transform overflow-hidden rounded-2xl bg-white dark:bg-secondary-800 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-3xl sm:p-6">
                  ...
                  <div>
                    <div className="mt-3 text-center sm:mt-0 sm:text-left">
                      <DialogTitle
                        as="h3"
                        className="text-xl font-semibold leading-6 text-secondary-900 dark:text-white"
                      >
                            ...
                            <table className="min-w-full divide-y divide-secondary-300 dark:divide-secondary-700">
                              <thead className="bg-secondary-50 dark:bg-secondary-900/50">
                                <tr>
                                  <th
                                    scope="col"
                                    className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-secondary-900 dark:text-white"
                                  >
                                    Attendee
                                  </th>
                                  <th
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div className="mt-4 flex items-end justify-between">
        ...
        <span
          className={`flex items-center gap-1 text-sm font-medium ${trend === 'up' ? 'text-meta-3' : trend === 'down' ? 'text-meta-1' : 'text-secondary-500'}`}
        >
          {subValue}
          {trend === 'up' && (
            <svg
