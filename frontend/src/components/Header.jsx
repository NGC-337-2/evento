    ...
    <header className="sticky top-0 z-50 w-full border-b border-secondary-200 bg-white/80 backdrop-blur-md dark:bg-secondary-900/80 dark:border-secondary-800 transition-colors">
      ...
      >
        <div className="flex lg:flex-1">
          <Link
            to="/"
            className="-m-1.5 p-1.5 flex items-center gap-2 text-primary-600 dark:text-primary-500 font-bold text-xl tracking-tight"
          >
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:items-center lg:gap-x-4">
          ...
          {user ? (
            <Menu as="div" className="relative ml-3">
              ...
              >
                ...
                <MenuItem>
                  <Link
                    to="/dashboard"
                    className="block px-4 py-2 text-sm text-secondary-700 dark:text-secondary-200 data-[focus]:bg-secondary-100 dark:data-[focus]:bg-secondary-700 flex items-center gap-2"
                  >
                ...
                <MenuItem>
                  <button
                    ...
                    className="block w-full text-left px-4 py-2 text-sm text-red-600 dark:text-red-400 data-[focus]:bg-secondary-100 dark:data-[focus]:bg-secondary-700 flex items-center gap-2"
                  >
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                to="/register"
                className="rounded-md bg-primary-600 px-3.5 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600 transition-colors"
              >
                Sign up
              </Link>
            </div>
                ...
                {user ? (
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 px-3 mb-6">
                      ...
                      <div>
                        <div className="text-base font-medium text-secondary-900 dark:text-white">
                          {user.name}
                        </div>
