...
import { 
    LayoutDashboard, Calendar, User, ListTodo, 
    Table, BookOpen, MessageSquare, Inbox, FileText, 
    PieChart, Boxes, ChevronDown 
} from 'lucide-react';
...
const navigation = [
    ...
    { name: 'Create Event', icon: ListTodo, href: '/manage/events/create', roles: ['organizer', 'admin'] },
];
